                      ...
                      switch (n.type) {
                        case 's':
                          ...
                          if ((m(r, o, i, s), r !== l.version))
                            throw new Error(
                              'Incompatible SockJS! Main site uses: "' + r + '", the iframe: "' + l.version + '".'
                            );
            ...
            (function () {
              ...
              function y(e, t, n) {
                ...
                d.call(this),
                  ...
                  (n = n || {}).protocols_whitelist &&
                    h.warn("'protocols_whitelist' is DEPRECATED. Use 'transports' instead."),
              ...
              e(y, d),
                ...
                (y.prototype.send = function (e) {
                  if (('string' != typeof e && (e = '' + e), this.readyState === y.CONNECTING))
                ...
                (y.prototype._transportClose = function (e, t) {
                  b('_transportClose', this.transport, e, t),
                    ...
                    g(e) || 2e3 === e || this.readyState !== y.CONNECTING ? this._close(e, t) : this._connect();
                }),
                (y.prototype._open = function () {
                  b('_open', this._transport && this._transport.transportName, this.readyState),
                    this.readyState === y.CONNECTING
        ...
        function (e, t, n) {
          ...
          d(r, {
            bind: function (t) {
              ...
              for (var r = u.call(arguments, 1), e = Math.max(0, n.length - r.length), o = [], i = 0; i < e; i++)
                o.push('$' + i);
              var s = Function(
                'binder',
                  ...
                  1 < arguments.length &&
                    (o = (function (e) {
                      ...
                      return (
                        t != t
                          ? (t = 0)
                          : 0 !== t && t !== 1 / 0 && t !== -1 / 0 && (t = (0 < t || -1) * Math.floor(Math.abs(t))),
                        t
                      );
                    })(t)),
                    ...
                    if (o.xhr) {
                      ...
                      switch ((u('readyState', n.readyState), n.readyState)) {
                        case 3:
                          ...
                          u('status', t),
                            1223 === t && (t = 204),
                            200 === t && e && 0 < e.length && (u('chunk'), o.emit('chunk', t, e));
                          break;
                        case 4:
                          (t = n.status),
                            u('status', t),
        ...
        function (e, t, n) {
          ...
          r(f, i),
                  ...
                  switch (n.type) {
                    case 's':
                      this.iframeObj.loaded(),
                        this.postMessage('s', JSON.stringify([o, this.transport, this.transUrl, this.baseUrl]));
                      break;
                    case 't':
            ...
            (f.prototype.postMessage = function (e, t) {
              c('postMessage', e, t),
                this.iframeObj.post(JSON.stringify({ windowId: this.windowId, type: e, data: t || '' }), this.origin);
            }),
            ...
            (s.prototype.sendSchedule = function () {
              ...
              if (0 < this.sendBuffer.length) {
                ...
                (this.sendStop = this.sender(this.url, e, function (e) {
                  (t.sendStop = null),
                    e
                      ? (i('error', e), t.emit('close', e.code || 1006, 'Sending error: ' + e), t.close())
                      : t.sendScheduleWait();
                })),
                  (this.sendBuffer = []);
              }
                  ...
                  if (
                    ...
                    if (s.isOpera())
                      ((t = this.script2 = c.document.createElement('script')).text =
                        "try{var a = document.getElementById('" + r.id + "'); if(a)a.onerror();}catch(x){};"),
                        (r.async = t.async = !1);
                    else {
                      try {
              ...
              t.exports = {
                attachEvent: function (e, t) {
                  void 0 !== s.addEventListener
                    ...
                    : s.document && s.attachEvent && (s.document.attachEvent('on' + e, t), s.attachEvent('on' + e, t));
                },
                detachEvent: function (e, t) {
                  void 0 !== s.addEventListener
                    ? s.removeEventListener(e, t, !1)
                    : s.document && s.detachEvent && (s.document.detachEvent('on' + e, t), s.detachEvent('on' + e, t));
                },
              ...
              (p.exports = {
                ...
                postMessage: function (e, t) {
                  d.parent !== d
                    ? d.parent.postMessage(
                        JSON.stringify({ windowId: p.exports.currentWindowId, type: e, data: t || '' }),
                        '*'
                      )
                ...
                d.document &&
                  (p.exports.iframeEnabled =
                    ('function' == typeof d.postMessage || 'object' == typeof d.postMessage) && !e.isKonqueror());
            }).call(this);
          }).call(
            this,
            'undefined' != typeof global
          ...
          (function (a) {
            (function () {
              ...
              function g(e) {
                var t,
                  n =
                    ('undefined' != typeof window ? window : void 0 !== a ? a : 'undefined' != typeof self ? self : {})
                      .location || {},
                  r = {},
                  o = typeof (e = e || n);
              ...
              function x(e, t) {
                ...
                return (
                  i
                    ? (a = s ? ((n = r[2] + r[3] + r[4]), r[2].length + r[3].length) : ((n = r[2] + r[4]), r[2].length))
                    : s
              ...
              function _(e, t, n) {
                ...
                for (
                  'object' != c && 'string' != c && ((n = t), (t = null)),
                    ...
                    (('file:' === o.protocol && (2 !== o.slashesCount || v.test(e))) ||
                      (!o.slashes && (o.protocol || o.slashesCount < 2 || !w(f.protocol)))) &&
                      (u[3] = [/(.*)/, 'pathname']);
                  h < u.length;
                  h++
                )
                ...
                n && (f.query = n(f.query)),
                  ...
                  '/' !== f.pathname.charAt(0) && w(f.protocol) && (f.pathname = '/' + f.pathname),
              ...
              (_.prototype = {
                set: function (e, t, n) {
                  ...
                  switch (e) {
                    ...
                    case 'port':
                      (r[e] = t),
                        d(t, r.protocol) ? t && (r.host = r.hostname + ':' + t) : ((r.host = r.hostname), (r[e] = ''));
                      break;
                    case 'hostname':
                  ...
                  return (
                    ...
                    (r.origin =
                      'file:' !== r.protocol && w(r.protocol) && r.host ? r.protocol + '//' + r.host : 'null'),
                    (r.href = r.toString()),
                    r
                  );
                },
                toString: function (e) {
                  ...
                  return (
                    n.username
                      ...
                      : n.password
                      ? ((i += ':' + n.password), (i += '@'))
                      : 'file:' !== n.protocol && w(n.protocol) && !r && '/' !== n.pathname && (i += '@'),

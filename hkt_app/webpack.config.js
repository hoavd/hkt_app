...
module.exports = (env, argv) => {
  ...
  const config = {
    ...
    module: {
      rules: [
        {
          test: /\.jsx?$/, // duyệt các file .ts || .tsx
        ...
        {
          test: /\.(png|svg|jpg|gif|mp4|mp3|wav)$/, // Dùng để import file ảnh, nếu có video/ảnh định dạng khác thì thêm vào đây
          use: [
            {
              loader: 'file-loader',
              options: {
    ...
    devServer: {
      ...
      port: 4000, // Chạy port 3000 khi dev
